<template>
    ...
    <nav>
        ...
        <router-link v-if='isLoggedIn' style="text-decoration: none" to="standings">Standings</router-link>
        <router-link v-if='isLoggedIn' style="text-decoration: none" to="rosters">Rosters</router-link>
